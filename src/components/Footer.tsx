        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-12">
          ...
          <div className="lg:pl-8">
            ...
            <p className="text-white/70 text-sm mb-6 leading-relaxed">
              Your Case Isn't Just a Number. It's Your Life. We provide direct attorney access for personal injury cases
            ...
            <div className="flex flex-col gap-3">
              ...
              <a
                href="mailto:myattorney@friedlandlaw.com"
                className="flex items-center gap-2 text-white/80 hover:text-gold transition-colors text-sm"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={item}>
                  <Link
                    to={`/practice-areas/${item.toLowerCase().replace(/ /g, "-").replace("&", "and")}`}
                    className="text-white/70 hover:text-gold transition-colors text-sm"
                  >
                    {item}
                  </Link>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-2 text-sm text-white/70">
                ...
                <span>
                  <strong>New York:</strong> 50 Broad St #1502
                  <br />
                  New York, NY 10004
                </span>
              </li>
              <li className="flex items-start gap-2 text-sm text-white/70">
                <MapPin size={16} className="text-gold shrink-0 mt-0.5" />
                <span>
                  <strong>Florida:</strong> 101 NE 3rd Ave #1600
                  <br />
              ...
              <li className="flex items-start gap-2 text-sm text-white/70">
                <MapPin size={16} className="text-gold shrink-0 mt-0.5" />
                <span>
                  <strong>New Jersey:</strong> 70 Grand Ave #107
                  <br />
                  River Edge, NJ 07661
                </span>
              </li>
